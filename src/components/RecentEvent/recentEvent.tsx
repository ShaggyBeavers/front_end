                ...
                <div className='rec_ev_con'>
                    ...
                    <div className='rec_ev_bot'>
                        <div className='rec_ev_left'>
                            <h5>Мадридська поліція затримала  5 осіб, які намагалися продати намиста, браслети та сережки, що датуються греко-скіфським періодом між VIII та IV ст. до нашої ери
                                <br /><br />
                                Загалом вилучили 11 предметів та ...</h5>
                                <a href="#">Читати більше</a>
                        </div>
                        <div className='rec_ev_right'>
                            <img src="./icons/rec_ev_line.svg" className='rec_ev_line'/>
                            <img src="./temp/rec_ev_placeholder.svg" className='rec_ev_pic'/>
                        </div>
                    </div>
                </div>
            </div>
