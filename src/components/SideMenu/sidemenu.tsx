...
const SideMenu = () => {
    ...
    const [modals, setModals] = useState<IModal>({
        settings: {isOpen: false, content: <Settings/>, styles: "settings-window"},
        addRelic: {isOpen: false, content: <AddRelicModal/>, styles: "add-relic-window"},
        addModerator: {isOpen: false, content: <AddModeratorModal/>, styles: "add-moderator-window"},
        moderatorsList: {isOpen: false, content: <ModeratorsListModal/>, styles: "moderators-list-window"},
        addCategory: {isOpen: false, content: <AddCategoryModal/>, styles: "add-category-window"},
    });
       ...
       <div className="flex-box">
            <div className="name-banner">
                ...
                <div className="row2">
                    ...
                    <p className="email">bober.na.pliazhe.lezhut@bober.ua</p>
                </div>
            </div>
            <DefaultButton
                height={38}
