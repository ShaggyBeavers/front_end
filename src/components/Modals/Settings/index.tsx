...
const Settings = () => {
    ...
    const [isCategoryListVisible, setIsCategoryListVisible] = React.useState(false);
    ...
    return (
        <form className="table-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <label 
                ...
                <Arrow className={`arrow${isCategoryListVisible ? ' arrow-up' : ''}`} 
                    arrowStyles={{stroke: "black", width: "1rem", height: "0.45rem",}}
                />        
            </label>
